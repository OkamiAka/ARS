...
$info_page="Matériel emprunter";
include("menu.php"); ?>
<title>Matériel emprunter</title><br/>
<a id="tr" href="export_pdf.php?emprunter" target="_blank"><input type="submit" value="Export PDF" id="but"></a>
<br/>
...
if($result->num_rows>0)
{
	while($row = $result-> fetch_assoc())
	{
		...
		<center><?php
		echo("Materiel emprunter<hr/>id: ".$row["id_materiel"]."<br/>"." type materiel: ".$row["type_materiel"]."<br/>"." Marque: ".$row["Marque_materiel"]."<br/>"." Modele: ".$row["Modele_materiel"]."<br/>"." Numero de serie ".$row["Numero_de_serie"]);
		...
		?></center></td></tr><tr><td>
			...
			?>
		</td></tr></table><!--l'emprunteur--></center></td>
		<?php
	}
	?>
		</tr></center>
