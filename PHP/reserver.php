...
$info_page="Demande d'emprunt";
?>
<?php include("menu.php"); ?>
<title>Demande d'emprunt</title><br/><br/>
<a id="tr" href="export_pdf.php?reserver" target="_blank"><input type="submit" value="Export PDF" id="but"></a>
<br/>
<?php
if (isset($_GET['refu'])) {
...
if($result->num_rows>0)
{
	while($row = $result-> fetch_assoc())
	{
		...
		<center><?php
		echo("Materiel demander<hr/>Numero materiel: ".$row["id_materiel"]."<br/>"." type materiel: ".$row["type_materiel"]."<br/>"." Marque: ".$row["Marque_materiel"]."<br/>"." Modele: ".$row["Modele_materiel"]."<br/>"." Numero de serie ".$row["Numero_de_serie"]);
		...
		echo("Demande effectuée le ".$date_reservation." <br/>par:<hr/>Nom: ".$emprunteur["nom_emprunteur"]."<br/>"." Prenom: ".$emprunteur["prenom_emprunteur"]."<br/>"." Numero de bureau: N°".$emprunteur["numero_bureau_emprunteur"]."<br/>"." Numero de telephone: ".$numero_telephone_emprunteur);
		?></center></td></tr><tr><td>
			<?php
		...
		<?php if ($info["Type"]=='Technicien') { ?>
			<a id="tr" href="reserver.php?id=<?php echo($row["id_materiel"])?>&refu"> <input type="submit" value="Refuser l'emprunt" id="but"> </a><!--l'emprunteur--></center></td><?php
		}
